...
progressUpdate(goal: 2000, steps: 1500)
progressUpdate(goal: 1000, steps: 80)
progressUpdate(goal: 3000, steps: 3000)
/*:
...
pacing(currentDistance: 5, totalDistance: 8, currentTime: 50.0, goalTime: 60.0)
