...
print("Congratulations! You have ran a total distance of \(firstRun.distance / 1000) kilometers in \(firstRun.time) minutes with an elevation gain of \(firstRun.elevation) meters.")
