 ...
 */
let optionalComputer = Computer(ram: 8, yearManufactured: 2016)

if let computer = optionalComputer {
    print(computer.ram)
    print(computer.yearManufactured)
}

let nilComputer = Computer(ram: 0, yearManufactured: 1900)

if let computer = nilComputer {
    print(computer.ram)
    print(computer.yearManufactured)
}
